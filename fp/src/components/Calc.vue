<template>
  <div class="hello">
    ...
    <div class="calculate">
      ...
      <hr />
      <button class="btn" name="reset" @click="(result = 0), (error = '')">
        reset
      </button>
    ...
    <div class="keyboard">
      ...
      <div v-show="checked" class="keyboardKey">
        <button
          class="keyboard-btn"
          v-for="(btn, idx) in keyboardBtns"
        ...
        <button class="keyboard-btn" name="removeBtn" @click="removeOperand">
          Delete
        </button>
